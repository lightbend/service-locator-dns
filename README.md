...
```scala
libraryDependencies += "com.lightbend" %% "service-locator-dns" % "2.2.3"
```
...
```scala
libraryDependencies += "com.lightbend" %% "lagom13-java-service-locator-dns" % "2.2.3"
```
...
```scala
libraryDependencies += "com.lightbend" %% "lagom13-scala-service-locator-dns" % "2.2.3"
```
